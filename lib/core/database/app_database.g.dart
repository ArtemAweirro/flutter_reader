...
class Comment extends DataClass implements Insertable<Comment> {
  ...
  Comment copyWith({
    ...
    offsetY: offsetY.present ? offsetY.value : this.offsetY,
    createdAt: createdAt ?? this.createdAt,
  );
  ...
  @override
  int get hashCode =>
      Object.hash(id, bookId, position, comment, offsetY, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Comment &&
...
final class $$BooksTableReferences
  ...
  static MultiTypedResultKey<$CommentsTable, List<Comment>> _commentsRefsTable(
    ...
    db.comments,
    aliasName: 'books__id__comments__book_id',
  );
...
class $$BooksTableTableManager
    extends
        RootTableManager<
          ...
          Book,
          PrefetchHooks Function({bool bookmarksRefs, bool commentsRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          prefetchHooksCallback:
              ({bookmarksRefs = false, commentsRefs = false}) {
                return PrefetchHooks(
                  ...
                  getPrefetchedDataCallback: (items) async {
                    return [
                      ...
                      if (commentsRefs)
                        await $_getPrefetchedData<Book, $BooksTable, Comment>(
                          currentTable: table,
                          referencedTable: $$BooksTableReferences
...
final class $$CommentsTableReferences
  ...
  static $BooksTable _bookIdTable(_$AppDatabase db) =>
      db.books.createAlias('comments__book_id__books__id');
